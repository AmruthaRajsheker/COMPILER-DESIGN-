...
3)	Until the symbol is ‘;’, do the following: </br>
         a.	If the next character of the symbol is an operator then print it as an operator. </br>
         b.	If the next character of the symbol is a variable, then insert it into symbol table and print it as an identifier. </br>
